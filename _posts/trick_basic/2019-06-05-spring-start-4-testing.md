...
layout: post
comments: true
title: Spring 프로젝트 시작하기 (4) - Testing
tags: [요령과 기본, Spring]
---
...
![1]({{ site.images | relative_url }}/posts/trick_basic/2019-06-05-spring-start-4-testing/1.png) 
  
테스트 실패시 출력화면  

![2]({{ site.images | relative_url }}/posts/trick_basic/2019-06-05-spring-start-4-testing/2.png) 
...
테스트에 대한 개인적인 견해가 담긴 포스팅을 공유합니다.   
- [다시세우는 테스트코드 작성전략](https://taes-k.github.io/2019/09/27/spring-junit-testing-strategy)
